...
1. Нужно вытащить все города из базы.(allCity) Осуществляется get запросом

http://localhost:1010/cities/allCity

2. Получить все улицы города(allStreetInCity)
...
4. Получение списка магазинов через фильтрацию.(listFiltr)
